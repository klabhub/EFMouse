classdef EFMouse < handle
    ...
    methods (Access = public)
        ...
        function plotEf(o,pv)
            ...
            if pv.slice
                ...
                slice_node_idx = find(abs(o.mesh.node(row,:) - pv.slice_pos) <= 0.5);
                ...
                pdeplot3D(o.mesh.node,slice_elem(:,slice_label==tissueId),ColorMapData = data);
            else
        ...
        function plotMesh(o,pv)
            ...
            arguments
                ...
                pv.tissue (1,1) string {mustBeMember(pv.tissue,["gray","skin"])}="gray" 
            end
            ...
            [tf,ix] = meshHasTissue(o,pv.tissue);
            if tf
    ...
    methods (Access=protected)
        ...
        function computeMesh(o,pv)
            ...
            o.startLog;
            tic
            fprintf('----Starting computeMesh...%s\n',datetime('now'));
            disp(o)
            ...
            % stop logging
            o.stage = Stage.MESH;
            fprintf('----computeMesh elapsed time: %.4f seconds\n\n', toc);
            o.stopLog;
            warning(warnStt);
        ...
        function computeVoxelSpace(o,pv)
            ...
            % This is necessary to create a grid that covers the full mesh gray matter
